 ...
 * 
 * 使用方法:
 *   bun run scripts/generate-learning-materials.ts
 */
...
const learnDir = path.join(import.meta.dir, "../learn");
...
async function generateTopicSkeleton(topic: typeof topics[0]) {
